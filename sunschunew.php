...
$Number = $Title = $Bref = $Lessno = $Classv = $Mverse = $Cref = $Notes = $Ques = $Classv2 = null;
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($NumberError) && empty($TitleError) && empty($BrefError) && empty($LessnoError) && empty($ClassvError) && empty($MverseError)  && empty($CrefError) && empty($NotesError) && empty($QuesError) && empty($Classv2Error)){ 
        ...
        $sql = "INSERT INTO sunsch (id, title, bref, lessno, classv, mverse, cref, notes, ques, classv2) VALUES ('".$Number."', '".$Title."', '".$Bref."', '".$Lessno."', '".$Classv."', '".$Mverse."', cref='".$Cref."', '".$Notes."', '".$Ques."', '".$Classv2."')";
...
<div class="container">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" class="form-horizontal">
        <div class="form-group <?php echo !empty($NumberError)? 'error': ''; ?>">
            ...
            <div class="col-sm-10">
                <input name="id" id="id" class="form-control" type="text" placeholder="Number" size=100 >
                <?php
        ...
        <div class="form-group <?php echo !empty($TitleError)? 'error': ''; ?>">
            ...
            <div class="col-sm-10">
                <input name="title" id="title" class="form-control" type="text" placeholder="Title" size=100 >
                <?php
                if(!empty($TitleError)){
                    ?>
        ...
        <div class="form-group <?php echo !empty($BrefError)? 'error': ''; ?>">
            ...
            <div class="col-sm-10">
                <input name="bref" id="bref" class="form-control" type="text" placeholder="bref" size=100 >
                <?php
                if(!empty($BrefError)){
                    ?>
        ...
        <div class="form-group <?php echo !empty($LessnoError)? 'error': ''; ?>">
            ...
            <div class="col-sm-10">
                <input name="lessno" id="lessno" class="form-control" type="text" placeholder="Lessno" size=100 >
                <?php
        ...
        <div class="form-group <?php echo !empty($ClassvError)? 'error': ''; ?>">
            ...
            <div class="col-sm-10">
                <input name="classv" id="classv" type="text" placeholder="text" >
                <?php
        ...
        <div class="form-group <?php echo !empty($MverseError)? 'error': ''; ?>">
            ...
            <div class="col-sm-10">
                <textarea name="mverse" id="mverse" type="text" placeholder="text"></textarea>
                <script>
                    tinymce.init({
                    selector: 'textarea',
        ...
        <div class="form-group <?php echo !empty($CrefError)? 'error': ''; ?>">
            ...
            <div class="col-sm-10">
                <textarea name="cref" id="cref" type="text" placeholder="text" ></textarea>
                <script>
                    tinymce.init({
                    selector: 'textarea',
                    plugins: 'advlist autolink lists link image charmap print preview hr anchor pagebreak',
        ...
        <div class="form-group <?php echo !empty($NotesError)? 'error': ''; ?>">
            ...
            <div class="col-sm-10">
                <textarea name="notes" id="notes" type="text" placeholder="text"></textarea>
                <script>
                    tinymce.init({
                    selector: 'textarea',
                    plugins: 'advlist autolink lists link image charmap print preview hr anchor pagebreak',
        ...
        <div class="form-group <?php echo !empty($QuesError)? 'error': ''; ?>">
            ...
            <div class="col-sm-10">
                <textarea name="ques" id="ques" type="text" placeholder="text"></textarea>
                <script>
                    tinymce.init({
                    selector: 'textarea',
                    plugins: 'advlist autolink lists link image charmap print preview hr anchor pagebreak',
        ...
        <div class="form-group <?php echo !empty($Classv2Error)? 'error': ''; ?>">
            ...
            <div class="col-sm-10">
                <input name="classv2" id="classv2" type="text" placeholder="text" >
                <?php
