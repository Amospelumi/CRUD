...
$Number = $Lessno = $Class  = $Title = $Text = $Mverse = $Intro  = $Items = $Conclusion = null;
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($NumberError) && empty($LessnoError) && empty($ClassError) && empty($TitleError) && empty($TextError) && empty($MverseError) && empty($IntroError) && empty($ItemsError) && empty($ConclusionError)){ 
        ...
        $sql = "INSERT INTO bible_study (id,lesson_no,class, title,text,mverse,intro,items,conclusion) VALUES('".$Number."', '".$Lessno."', '".$Class."', '".$Title."', '".$Text."', '".$Mverse."', '".$Intro."', '".$Items."', '".$Conclusion."')";
