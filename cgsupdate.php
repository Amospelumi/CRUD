...
$query = "SELECT * FROM cgs WHERE cgs_no=".$id;
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if( empty($NumberError) && empty($TitleError) && empty($ContentError) ){
        ...
        $sql = "UPDATE cgs SET cgs_no='".$Number."', title='".$Title."', lyrics='".$Content."' WHERE cgs_no='".$id."' ";
...
<div class="container">
    ...
    <form action="cgsupdate.php?id=<?php echo $id;?>"  method="POST" class="form-horizontal">
